...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleQuestVerified = (quest, successMessage) => {
        ...
        // --- Trigger Skill Drop ---
        // ADDED DEBUG LOGS
        console.log("DEBUG: Checking if grantRandomSkill function exists...");
        if (typeof window.grantRandomSkill === 'function') {
            console.log("DEBUG: grantRandomSkill function found. Setting timeout...");
            setTimeout(() => {
                console.log("DEBUG: Executing grantRandomSkill via setTimeout...");
