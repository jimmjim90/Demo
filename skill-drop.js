...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const getLocalStorage = window.getLocalStorage || function(key, defaultValue) {
        ...
        try {
            ...
            console.error(`[skill-drop.js] Error parsing localStorage key "${key}":`, e);
            return defaultValue;
        }
    };
    ...
    const setLocalStorage = window.setLocalStorage || function(key, value) {
        try {
            ...
            console.error(`[skill-drop.js] Error setting localStorage key "${key}":`, e);
        }
    };
    ...
    window.grantRandomSkill = () => {
        console.log("[skill-drop.js] Attempting to grant a random skill..."); // Added identifier
        ...
        if (availableSkills.length === 0) {
            console.log("[skill-drop.js] All skills have been unlocked!");
        ...
        console.log(`[skill-drop.js] Skill Granted: ${newSkillData.name}`);
    ...
    const displayNewSkillModal = (skillData, dateReceived) => {
        ...
        console.log(`[skill-drop.js] Displaying skill modal for ${skillData.name}`);
    };
    ...
    const displaySkillVault = () => {
        ...
        if (unlockedSkills.length === 0) {
         ...
         console.log(`[skill-drop.js] Skill Vault updated. Displaying ${unlockedSkills.length} skills.`);
    };
    ...
    if (receiveSkillBtn) {
        ...
        console.warn("[skill-drop.js] Manual skill trigger button (#receive-skill-btn) not found.");
    }
    ...
    if (closeSkillModalBtn) {
        closeSkillModalBtn.addEventListener('click', closeSkillModal);
         ...
         console.warn("[skill-drop.js] Skill modal close button (#close-skill-modal-btn) not found.");
    }
    ...
    displaySkillVault();
    console.log("[skill-drop.js] Skill system initialized."); // Added init message
